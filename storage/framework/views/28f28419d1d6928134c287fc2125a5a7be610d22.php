            ...
            <ul class="nav navbar-nav">
                            ...
                            <ul class="menu">
                                <li><!-- start message -->
                                    <a href="#">
                                        <div class="pull-left">
                                            <!-- User Image -->
                                            <img src="<?php echo e(asset("/bower_components/admin-lte/dist/img/user3-128x128.jpg")); ?>" class="img-circle" alt="User Image"/>
                                        </div>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <img src="<?php echo e(asset("/bower_components/admin-lte/dist/img/userADMIN.jpg")); ?>" class="user-image" alt="User Image"/>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            ...
                            <div class="pull-right">
                                <a href="<?php echo e(url('/logout')); ?>" class="btn btn-default btn-flat">Cerrar session</a>
                            </div>
                        </li>
                    </ul>
                </li>
