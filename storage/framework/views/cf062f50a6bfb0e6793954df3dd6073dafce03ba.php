...
<?php $__env->startSection('content'); ?>
     ...
     <?php echo $__env->make('common.errors', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <?php echo Form::open(['route' => 'proyectos.store']); ?>
            ...
            <div class="box-body">
             <?php echo $__env->make('proyectos.fields', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                         <!-- Submit Field -->
              <div class="form-group col-sm-12">
                  <?php echo Form::button('<span class="glyphicon glyphicon-floppy-disk" ></span> Guardar', ['type' => 'submit', 'class' => 'btn btn-success']); ?>

                  <a href="<?php echo route('proyectos.index'); ?>" class="btn btn-primary"><i class="fa fa-ban"></i> Cancelar</a>
              </div>
            </div>
        <?php echo Form::close(); ?>
