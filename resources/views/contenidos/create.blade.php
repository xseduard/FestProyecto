...
<div class="container-fluid col-md-12">
  ...
  <div class="box box-primary">
    <div class="box-header with-border">
      <h2 class="box-title">Crear nuevo  Contenido
      </h2>
    </div>
    <!-- /.box-header -->
    ...
    <div class="box-body" style="margin-top: 50px">
      ...
      <div class="form-group col-sm-12">
        {!! Form::button('<span class="button-text-anim">Registrar </span> <span class="button-icon-anim icon_floppy"> </span>', ['type' => 'submit', 'class' => 'button large thin teal btn-4 btn-4cc']) !!}
