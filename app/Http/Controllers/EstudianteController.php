...
class EstudianteController extends AppBaseController
{
    ...
    public function create()
    {
          $selectores = [                        
                        'areas'=> area::selArea(),
                        'programas' => programa::selPrograma(),
                        'regionals'=> Regional::selRegional(),
                        'municipios'=> municipio::selMunicipio()
                        ];

        return view('estudiantes.create')->with(['selectores' => $selectores]);
    ...
    public function edit($id)
    {
        ...
        return view('estudiantes.edit')->with(['estudiante'=> $estudiante, 'selectores' => $selectores]);
