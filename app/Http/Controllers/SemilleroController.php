...
class SemilleroController extends AppBaseController
{
    ...
    public function create()
    {
         $selectores = [
            ...
            'estudiantes'=> Estudiante::selEstudiante(),
            'docentes'=> User::selUsuario('docente'),
            'grupo_investigacions'=> Grupo_Investigacion::selGrupo_Investigacion()
        ];

        return view('semilleros.create')->with(['selectores' => $selectores]);
    ...
    public function edit($id)
    {
        ...
        return view('semilleros.edit')->with(['semillero'=> $semillero, 'selectores' => $selectores]);
    }
